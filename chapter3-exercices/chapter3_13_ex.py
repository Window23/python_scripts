...
number_fact = int(input('Enter a number so you can find its factorial: '))
number_factorial = 1

for n in range(1, number_fact + 1):
    number_factorial *= n

print(f'The factorial for the chosen number {number_fact} is {number_factorial}.')
