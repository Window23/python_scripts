""" 3.31 (Intro to Data Science: Categorical Data)
    ...
    Categorical values are descriptive names like Boxer, Poodle, Collie, Beagle, Bulldog and Chihuahua.
    ...
    answer... mode because it calculates the occurence of the term.. also the median(but needs to sort first)"""
